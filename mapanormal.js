var lat, long, key_do_google, resposta_inserir_linha, total2, codigounico, polilinha, tabelaidsaldo, codigorec, temcupom, resultado_pesquisa, lat0, lat1, lat2, porcentagem, log0, log1, enderecoinicial, enderecofinal, tabelaidgasto, tabelaidlogin, tabelaidcodigo, Item, saidaa, log2, total1, distancia, tempo, latitude, longitude, tabelaidgastodata, idrec, distanciatotal, cupomvalido, desconto, tabelaidsaldodata, nomerec, tabelaidcorridavalor, telefonerec, endereco_texto, lng, porcetagem1, chavepixrec, tabelaidloginnome, enderecorec, tabelaidcorridacliente, valorrec, tabelaidcorridas, endereco, mensagemcompleta;
...
function enviar() {
  function insertRow() {
  let jsonData = {};
  let colunas = ['local', 'destino', 'extra', 'hotel', 'identificador', 'status'];
  let valores = [enderecoinicial, enderecofinal, ['Valor =',total1,' Distancia =',distanciatotal,' KM'].join(''), codigorec, codigounico, 'solicitando'];
...
function calculos() {
  ...
  $("#text_2").html(('R$' + String(format_decimal_number((txt_to_number(total1)), 2, false))));
...
var bb_url_gs = "https://script.google.com/macros/s/AKfycbyodCerYeb088DpeJTD4NpDvh08Zr-jSAhzlkdana88QzCPf7fXCMBPrlgGqN9L9vQRXg/exec" + "?spreadsheetId=" + "1uMlErhFcB810XfABcPJzkeHe1wfbr5GurvXWCoAZuY0";
//feito com bootblocks.com.br
...
//feito com bootblocks.com.br
  ...
  document.getElementById('telafim').style.width = '95' + "%";
  document.getElementById('telafim').style.height = "auto";
  $("#"+'telafim').css("margin-left", 5+ "px");
  $("#"+'telafim').css("margin-right", 5+ "px");
